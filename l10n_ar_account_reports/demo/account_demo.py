...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _install_l10n_ar_account_reports_demo(self, companies):
        ...
        for company in companies.filtered(lambda x: x.chart_template in ("ar_base", "ar_ri", "ar_ex")):
            demo_data = {
                'account.fiscal.position': self._l10n_ar_get_demo_data_fiscal_position(company),
                # 'account.move': self._l10n_ar_get_demo_data_move(company),
            }
    ...
    # <record id="fiscal_position_caba_cordoba_perc_line_caba" model="account.fiscal.position.l10n_ar_tax">
    ...
    #     <field name="name">Percepciones CABA</field>
    ...
    @api.model
    def _l10n_ar_get_demo_data_fiscal_position(self, company=False):
        return {
            'demo_fp_misiones': {
                ...
                'auto_apply': True,
                'country_id': 'base.ar',
                'state_ids': [Command.set([
                    'base.state_ar_n',
                ])],
                'l10n_ar_afip_responsibility_type_ids': [Command.set([
                    'l10n_ar.res_IVARI',
                ])],
            }
        }

    def _l10n_ar_get_demo_data_move(self, company=False):
    ...
    #     <field name="invoice_date" eval="(DateTime.today() + relativedelta(months=-1)).strftime('%Y-%m')+'-01'"/>
