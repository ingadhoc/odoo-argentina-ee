...
class L10n_ArMendozaReportHandler(models.AbstractModel):
        ...
        txt_export_button = [
            {
                ...
                "sequence": 30,
                "action": "export_file",
                "action_param": "mendoza_ret_perc_txt",
            ...
            },
            {
                ...
                "sequence": 30,
                "action": "export_file",
                "action_param": "nc_mendoza_ret_perc_txt",
                "file_export_type": "TXT",
            },
        ]
    ...
    def mendoza_ret_perc_txt(self, options):
        return {
            "file_name": "Perc/Ret IIBB Mendoza Aplicadas.txt",
            "file_content": self._mendoza_book_get_txt_files(options),
            "file_type": "txt",
        }

    def nc_mendoza_ret_perc_txt(self, options):
        return {
            "file_name": "NC Perc/Ret IIBB Mendoza Aplicadas.txt",
            "file_content": self._mendoza_book_get_txt_files(options, refund=True),
            "file_type": "txt",
        }

    def _mendoza_book_get_txt_files(self, options, refund=False):
        """Returns Mendoza txt content"""
        move_lines = self._mendoza_book_get_txt_lines(options, refund=refund)
    ...
    def _get_mendoza_txt_content(self, move_lines, refund=False):
