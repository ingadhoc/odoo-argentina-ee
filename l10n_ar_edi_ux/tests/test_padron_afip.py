    ...
    def test_check_padron_afip(self):
        response_responsable_inscripto = {
            ...
            "datosRegimenGeneral": {
                ...
                "regimen": [
                    {
                        "descripcionRegimen": "COMPRA/VENTA GRANOS Y LEGUMBRES SEC. ART10 INC.A).2- OP. PRIMARIAS",
                        "idImpuesto": 217,
                        "idRegimen": 22,
                        "periodo": 199603,
                    ...
                    {
                        "descripcionRegimen": "SUBSIDIOS ABONADOS POR ESTADOS NACIONAL...",
                        "idImpuesto": 217,
                        "idRegimen": 780,
                        "periodo": 200807,
                        "tipoRegimen": "RETENCION",
                    ...
                    {
                        "descripcionRegimen": "EMPRESAS DE SERVICIOS EVENTUALES",
                        "idImpuesto": 353,
                        "idRegimen": 742,
                        "periodo": 200001,
                        "tipoRegimen": "RETENCION",
                    ...
                    {
                        "descripcionRegimen": "REG.PER.AL VALOR AGREGADO - EMPRESAS...",
                        "idImpuesto": 767,
                        "idRegimen": 493,
                        "periodo": 200001,
                    ...
                    {
                        "descripcionRegimen": "RANCHO - DISTRIBUIDORES",
                        "idImpuesto": 103,
                        "idRegimen": 73,
                        "periodo": 20200102,
                        "tipoRegimen": None,
