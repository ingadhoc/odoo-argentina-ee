...
class AccountJournal(models.Model):
    ...
    settlement_tax = fields.Selection(selection_add=[("iibb_tucuman", "TXT Retenciones/Percepciones Tucuman")])
    ...
    def iibb_tucuman_files_values(self, move_lines):
        ...
        return [
            ...
            },
            {
                ...
                "txt_content": self._iibb_tucuman_ncfact_txt_file(
                    lines.filtered(lambda x: x.move_type == "out_refund")
                ),
            },
        ]
    ...
    def _iibb_tucuman_validations(self, move_lines):
        ...
        if percepciones and len(percepciones) != len(move_lines):
            raise UserError(
                _(
                    "Debe generar archivos para TXT Tucuman por separado para retenciones por un lado y "
